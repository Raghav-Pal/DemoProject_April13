...
WebUI.callTestCase(findTestCase('April13/LoginTest'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/b_Directory'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_( Username  Admin  Password  admin123 )_divLogo'))
